...
class _HomeCarouselSliderState extends State<HomeCarouselSlider> {
  ...
  void _initSlides() {
    _slides = [
      const CarouselSlideData(
        ...
        description:
            'In steam-shrouded Oakhaven, forbidden transmutation awakens an ancient destiny.',
        rating: '4.9 ★',
        novelId: 'novel_1',
      ),
      const CarouselSlideData(
        ...
        description:
            'Seven iron keys unlock the haunting secrets of Yorkshire’s Blackwood Manor.',
        rating: '4.8 ★',
        novelId: 'novel_2',
      ),
      const CarouselSlideData(
        ...
        description:
            'Kai navigates the Orion nebula to safeguard the starlight conjunction core.',
        rating: '5.0 ★',
        novelId: 'novel_3',
      ),
      const CarouselSlideData(
        ...
        description:
            'Mapping the shifting realms beyond the Sunken Veil before time dissolves.',
        rating: '4.9 ★',
        novelId: 'novel_4',
      ),
      const CarouselSlideData(
        ...
        description:
            'An ancient codex reveals constellations bound to human destiny.',
        rating: '4.9 ★',
        novelId: 'novel_1',
      ),
    ];
  ...
  void _handleSlideTap(CarouselSlideData slide) {
    if (widget.novels.isNotEmpty && widget.onNovelTap != null) {
      final match = widget.novels.firstWhere(
        (n) =>
            n.id == slide.novelId ||
            n.title.toLowerCase() == slide.title.toLowerCase(),
        orElse: () => widget.novels.first,
      );
  ...
  Widget build(BuildContext context) {
    ...
    // Small width, larger height proportions (portrait book-card style)
    final double sliderHeight = isDesktop ? 390.0 : (isTablet ? 370.0 : 350.0);
    final double viewportFraction = isDesktop ? 0.38 : (isTablet ? 0.52 : 0.68);
      ...
      children: [
        ...
        CarouselSlider.builder(
          ...
          itemBuilder: (context, index, realIndex) {
            ...
            return Padding(
              // More spacing / margin between adjacent images
  ...
  Widget _buildSlideCard(CarouselSlideData slide) {
    return GestureDetector(
      onTap: () => _handleSlideTap(slide),
      child: Container(
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(AppRadii.xl),
          // Lightning Glowing Illuminated Border
          ...
          boxShadow: [
            ...
            BoxShadow(
              color: const Color(0xFFC47B49).withValues(alpha: 0.38),
              blurRadius: 16,
              spreadRadius: 1.2,
            ...
            BoxShadow(
              color: const Color(0xFFFFD580).withValues(alpha: 0.28),
              blurRadius: 8,
              spreadRadius: 0.5,
              offset: const Offset(0, 1),
            ),
        ...
        // 2.2px border wrapper for glowing gradient stroke
